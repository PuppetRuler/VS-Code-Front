<script setup lang="ts">
    ...
    const onChange: UniHelper.SwiperOnChange = (event) => {
        // 更新当前下标
        currentPicture.value = event.detail!.current
    }
    ...
    // 选择的商品信息
    const SkuPopupSelectText = computed(() => {
...
<template>
        ...
        <view class="goods">
            ...
            <view class="preview">
                ...
                <view class="indicator">
                    <text class="current">{{ currentPicture + 1 }}</text>
            ...
            <view class="action">
                <view class="item arrow" @tap="openSkuPopup(SkuMode.Both)">
                    ...
                    <text class="text ellipsis"> {{ SkuPopupSelectText }} </text>
                </view>
    ...
    <view class="toolbar" :style="{ paddingBottom: safeAreaInsets?.bottom + 'px' }">
        ...
        <view class="buttons">
            <view class="addcart" @tap="openSkuPopup(SkuMode.Buy)"> 加入购物车 </view>
            <view class="buynow" @tap="openSkuPopup(SkuMode.Cart)"> 立即购买 </view>
        </view>
    </view>
